...
?>
<!-- 2. Hero -->
<section class="relative min-h-[78vh] flex items-end hero-photo">
  ...
  <div class="max-w-[1440px] mx-auto px-margin-mobile lg:px-margin-desktop">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <?php foreach ($collections as $collection): ?>
        <a href="<?= e(base_url('properties.php?region=' . rawurlencode($collection['region']))) ?>" class="group relative min-h-[22rem] flex items-end p-6 text-on-primary overflow-hidden collection-photo no-underline">
...
<section class="py-section-gap">
  <div class="max-w-[1440px] mx-auto px-margin-mobile lg:px-margin-desktop grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div class="relative min-h-[28rem] img-placeholder">
